...
namespace SnowChess.Pieces
{
    ...
    {
        public King(char letter, int number, int side) : base(letter, number, side)
        {
        }
        ...
        public List<string> LegalMoves()
        {
            ...
            CheckSquare((char)(Letter + 1), Number + 1, ref moves);
            ...
            CheckSquare(Letter, Number + 1, ref moves);

            CheckSquare(Letter, Number - 1, ref moves);

            CheckSquare((char)(Letter + 1), Number, ref moves);
